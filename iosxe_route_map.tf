    ...
    for device in local.devices : [
      for route_map in try(local.device_config[device.name].route_maps, []) : {
        ...
        entries = [for e in try(route_map.entries, []) : {
          ...
          set_ip_default_global_next_hop_address     = try(e.set.ip_default_global_next_hop_address, local.defaults.iosxe.configuration.route_maps.entries.set.ip_default_global_next_hop_address, null)
          set_ip_default_next_hop_address            = try(e.set.ip_default_next_hop_address, local.defaults.iosxe.configuration.route_maps.entries.set.ip_default_next_hop_address, null)
          set_ip_global_next_hop_address             = try(e.set.ip_global_next_hop_address, local.defaults.iosxe.configuration.route_maps.entries.set.ip_global_next_hop_address, null)
          set_ip_next_hop_address                    = try(e.set.ip_next_hop_address, local.defaults.iosxe.configuration.route_maps.entries.set.ip_next_hop_address, null)
          ...
          set_ipv6_address                           = try(e.set.ipv6_address, local.defaults.iosxe.configuration.route_maps.entries.set.ipv6_address, null)
          ...
          set_ipv6_default_next_hop                  = try(e.set.ipv6_default_next_hop, local.defaults.iosxe.configuration.route_maps.entries.set.ipv6_default_next_hop, null)
          set_ipv6_next_hop                          = try(e.set.ipv6_next_hop, local.defaults.iosxe.configuration.route_maps.entries.set.ipv6_next_hop, null)
